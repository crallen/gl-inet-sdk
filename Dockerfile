...
RUN echo "America/Chicago" > /etc/timezone && \
    ...
    apt-get update && \
    apt-get install -y asciidoc bash bc binutils bzip2 curl fastjar flex gawk gcc genisoimage \
                       gettext git intltool jikespg libgtk2.0-dev libncurses5-dev libssl-dev make \
                       mercurial patch perl-modules python2.7-dev python3 rsync ruby sdcc \
